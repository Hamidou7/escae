...
<!-- Mirrored from www.radiustheme.com/demo/html/academics/academics/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Sep 2022 08:53:19 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div id="wrapper">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-3">
                                <div class="logo-area"style="display:flex;">
                                    <a href="index.html"><img class="img-responsive" style="margin-top: -20px; height: 70px;" src="img/logo.png" alt="logo"></a>
                                    <span style="margin-top: 5px;">ESCAE</span>
                                </div>
                            </div>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#">Actualités</a>
                                            <ul>
                                                ...
                                                <li class="has-child-menu"><a href="#">Evenements</a>
                                                    <ul class="thired-level">
                ...
                <div id="slider-direction-1" class="t-cn slider-direction">
                    <div class="slider-content s-tb slide-1">
                        <div class="title-container s-tb-c">
                            <div class="title1">Un autre regard sur la formation</div>
                    ...
                    <div class="row service1-wrapper">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 service-box1">
                            <div class="service-box-content">
                                <h3><a href="#">Formations de qualité</a></h3>
                                <p>Nous offrons des formations adaptées au marché de l'emploi.</p>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 service-box1">
                            <div class="service-box-content">
                                <h3><a href="#">Professeurs qualifiés</a></h3>
                                <p>Les experts du domaine.</p>
                            </div>
                            <div class="service-box-icon">
        ...
        <div class="about1-area">
            <div class="container">
                <h1 class="about-title wow fadeIn" data-wow-duration="1s" data-wow-delay=".2s">Bienvenue à ESCAE</h1>
                <p class="about-sub-title wow fadeIn" data-wow-duration="1s" data-wow-delay=".2s">Crée par la décision N°2014-00717/MESRS du juin 2014 et l’arrêté N°2015-0800/MESRS -SG su 16 Avril 2015, l’Ecole Spéciale de Commerce d’Administration et de l’Entreprenariat (ESCAE) fruit de la coopération Mali – Maroc est un centre privé de formation dans des domaines divers et variés.</p>
        ...
        <div class="courses1-area">
            <div class="container">
                <h2 class="title-default-left">Nos filières</h2>
            </div>
                ...
                <div class="rc-carousel" data-loop="true" data-items="4" data-margin="20" data-autoplay="false" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="true"
                    ...
                    <div class="courses-box1">
                        <div class="single-item-wrapper">
                            ...
                            <div class="courses-content-wrapper">
                                <h3 class="item-title"><a href="#">Finance Comptabilité</a></h3>
                                <p class="item-content">Rmply dummy text printing setting industry it’s free demo.</p>
                                <ul class="courses-info">
                                    <li>DUT
                                        <br><span style="color:red">200 000 F</span></li>
                                    <li>Licence
                                        <br><span style="color:red">300 000 F</span></li>
                                    <li>Master
                                        <br><span style="color:red"> 1 000 000 F</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="courses-box1">
                        <div class="single-item-wrapper">
                            ...
                            <div class="courses-content-wrapper">
                                <h3 class="item-title"><a href="#">Banque Microfinance / Assurance</a></h3>
                                <p class="item-content">Rmply dummy text printing setting industry it’s free demo.</p>
                                <ul class="courses-info">
                                    <li>DUT
                                        <br><span style="color:red">200 000 F</span></li>
                    ...
                    <div class="courses-box1">
                        <div class="single-item-wrapper">
                            ...
                            <div class="courses-content-wrapper">
                                <h3 class="item-title"><a href="#">Marketing - Communication</a></h3>
                                <p class="item-content">Rmply dummy text printing setting industry it’s free demo.</p>
                                <ul class="courses-info">
                                    <li>DUT
                                        <br><span style="color:red">200 000 F</span></li>
                    ...
                    <div class="courses-box1">
                        <div class="single-item-wrapper">
                            ...
                            <div class="courses-content-wrapper">
                                <h3 class="item-title"><a href="#">Gestion des Entreprises et des Administrations</a></h3>
                                <p class="item-content">Rmply dummy text printing setting industry it’s free demo.</p>
                                <ul class="courses-info">
                                    <li>DUT
                                        <br><span style="color:red">200 000 F</span></li>
                    ...
                    <div class="courses-box1">
                        <div class="single-item-wrapper">
                            ...
                            <div class="courses-content-wrapper">
                                <h3 class="item-title"><a href="#">Informatique de Gestion</a></h3>
                                <p class="item-content">Rmply dummy text printing setting industry it’s free demo.</p>
                                <ul class="courses-info">
                                    <li>DUT
                                        <br><span style="color:red">200 000 F</span></li>
                    ...
                    <div class="courses-box1">
                        <div class="single-item-wrapper">
                            ...
                            <div class="courses-content-wrapper">
                                <h3 class="item-title"><a href="#">Gestion des Ressources Humaines</a></h3>
                                <p class="item-content">Rmply dummy text printing setting industry it’s free demo.</p>
                                <ul class="courses-info">
                                    <li>DUT
                                        <br><span style="color:red">200 000 F</span></li>
                    ...
                    <div class="courses-box1">
                        <div class="single-item-wrapper">
                            ...
                            <div class="courses-content-wrapper">
                                <h3 class="item-title"><a href="#">Gestion Logistique et Transport</a></h3>
                                <p class="item-content">Rmply dummy text printing setting industry it’s free demo.</p>
                                <ul class="courses-info">
                                    <li>DUT
                                        <br><span style="color:red">200 000 F</span></li>
                    ...
                    <div class="courses-box1">
                        <div class="single-item-wrapper">
                            ...
                            <div class="courses-content-wrapper">
                                <h3 class="item-title"><a href="#">Secretariat et Assistante d'Administration</a></h3>
                                <p class="item-content">Rmply dummy text printing setting industry it’s free demo.</p>
                                <ul class="courses-info">
                                    <li>DUT
                                        <br><span style="color:red">200 000 F</span></li>
...
<!-- Mirrored from www.radiustheme.com/demo/html/academics/academics/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Sep 2022 08:54:41 GMT -->
</html>
